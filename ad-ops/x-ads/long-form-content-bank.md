...
| 日付 | アカウント | Draft | 投稿時刻（JST） |
|---|---|---|---|
| 月 5/25 | @tenichiliu | #1（8% 構造解説） | 08:00 |
| 火 5/26 | @jirosan | #3（DP 毎日触る） | 12:00 |
| 水 5/27 | @ss_unei_chan | #5（家具失敗談） | 19:00 |
| 木 5/28 | @tenichiliu | #2（受賞振り返り） | 08:00 |
| 金 5/29 | @jirosan | #4（民泊新法 2026） | 12:00 |
| 土 5/30 | @ss_unei_chan | #6（オーナーダッシュボード） | 19:00 |

→ 6/1 PR TIMES 配信に向けて 1 週間前から長文砲火を仕掛ける。

---

## W3 以降のドラフト供給計画

毎週月曜朝に、Claude が次週分 6 本（5本柱 × 3アカウント切り口マトリクスから自動選択）をこのファイルに追記。テンイチ / ジロー / 運営チームが火曜中に最終チェック → 水曜から投稿開始。
