...
export const PRICING = {
  ...
  lines: [
    ...
    { label: '解約金', value: '¥0', note: '※最低契約期間 6ヶ月' },
...
export const FAQ = {
  ...
  items: [
    ...
    },
    {
      category: 'fee',
      q: '料金体系を教えてください。',
      a: '運営委託費は売上の8%、固定管理費は¥10,000/物件・月が基本です。解約金・違約金は ¥0、運営代行の初期費用も現在キャンペーンで ¥0 です（※最低契約期間 6ヶ月）。なお、新規開業（0→1）の場合は、許認可申請の行政書士費用や備品調達などの実費が別途発生します。',
    },
    {
      category: 'fee',
      q: '解約金はかかりますか？',
      a: '解約金は ¥0 で、いつでも解約いただけます（※最低契約期間 6ヶ月）。違約金も発生しません。',
    },
    {
      category: 'fee',
      q: '対応エリアはどこですか？',
...
export const CREDENTIALS = {
  ...
  compareOneLiner:
    '一般的な運用代行の手数料15〜25%に対して、SEKAI STAYは 8%＋月10,000円/物件。初期費用 ¥0、解約金 ¥0（※最低契約期間 6ヶ月）。',
