...
export const PRICING = {
  ...
  lines: [
    ...
    { label: '初期費用', value: '¥0', note: '通常¥100,000 → 現在キャンペーン中' },
  ...
  note: 'エリア、物件タイプ、運用状況によって最適なプランは変わります。個別の詳細はお見積もりとしてご案内します。',
...
export const FAQ = {
  ...
  items: [
    ...
    },
    {
      category: 'switch',
      q: '乗り換えに費用はかかりますか？',
      a: '現在、他社からの乗り換え費用は¥0でご案内しています。移行中の運用停止期間も最小化できるよう調整します。',
    },
    {
      category: 'new',
    ...
    },
    {
      ...
      a: '住宅宿泊事業法（民泊新法）・旅館業法いずれの手続きも、書類作成・申請手順・必要設備の整備までご案内します。行政書士との連携も可能です。',
    },
    {
      category: 'new',
      q: '物件選びから相談できますか？',
    ...
    },
    {
      category: 'fee',
      q: '料金体系を教えてください。',
      a: '運営委託費は売上の8%、固定管理費は¥5,000/室・月が基本です。最低契約期間・違約金はなく、初期費用も現在キャンペーンで¥0でご案内しています。',
    },
    {
      category: 'fee',
      q: '最低契約期間はありますか？',
