...
export const PRICING = {
  ...
  lines: [
    ...
    { label: '固定管理費', value: '¥10,000 / 室・月', note: '掲載・運営基盤の維持費' },
...
export const FAQ = {
  ...
  items: [
    ...
    },
    {
      category: 'fee',
      q: '料金体系を教えてください。',
      a: '運営委託費は売上の8%、固定管理費は¥10,000/室・月が基本です。最低契約期間・違約金はなく、運営代行の初期費用も現在キャンペーンで¥0でご案内しています。なお、新規開業（0→1）の場合は、許認可申請の行政書士費用や備品調達などの実費が別途発生します。',
    },
    {
      category: 'fee',
      q: '最低契約期間はありますか？',
...
export const CREDENTIALS = {
  ...
  compareOneLiner:
    '一般的な運用代行の手数料15〜25%に対して、SEKAI STAYは 8%＋月10,000円/室。最低契約期間なし、初期費用0円、解約手数料も0円です。',
