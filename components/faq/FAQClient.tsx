...
const FAQ_ITEMS: { q: string; a: string; category: string }[] = [
  // ── 料金・費用 ──
  {
    ...
    a: '初期費用は現在キャンペーンで0円（通常10万円）。月額は固定管理費10,000円/物件と売上の8%です。収支シミュレーションを無料で作成いたしますので、お気軽にお問い合わせください。',
    category: 'fee',
  },
  {
  ...
  {
    q: '解約金はかかりますか？',
    a: '解約金は ¥0 で、いつでも解約可能です（※最低契約期間 6ヶ月）。成果でお選びいただけるよう、長期の縛りは設けていません。',
    category: 'contract',
  },
  {
  ...
  {
    q: '解約のタイミングや手続きは？',
    a: '解約金は ¥0 です（※最低契約期間 6ヶ月）。解約のお申し出から2ヶ月で契約を終了し、その間に受注済みのご予約は弊社で最後まで対応します。',
    category: 'contract',
  },
  {
