...
const FAQ_ITEMS: { q: string; a: string; category: string }[] = [
  // ── 料金・費用 ──
  {
    ...
    a: '初期費用は現在キャンペーンで0円（通常10万円）。月額は固定管理費10,000円/室と売上の8%です。収支シミュレーションを無料で作成いたしますので、お気軽にお問い合わせください。',
    category: 'fee',
  },
  {
    q: '宿泊がなかった月の費用はかかりますか？',
    a: '固定管理費（月額10,000円/室）のみとなります。変動運営委託費（8%）は売上に連動するため、宿泊がなければ発生しません。',
    category: 'fee',
  },
  {
