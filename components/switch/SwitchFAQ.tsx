...
const faqs = [
  {
    ...
    a: "はい。料金は「売上の8% ＋ ¥10,000/物件/月」のみで、初期費用（期間限定）・契約手数料・解約金・広告費・レポート作成費はすべて ¥0 です。清掃費はゲストの宿泊料金内でカバーされるため、オーナー様への別請求は発生しません。※最低契約期間 6ヶ月。",
  },
  {
    q: "途中で解約できますか？",
    a: "解約金は ¥0 で、いつでも解約可能です（※最低契約期間 6ヶ月）。2ヶ月前にご連絡いただければ、その時点で受注済みのご予約分は弊社が責任を持って最後まで対応し、スムーズに運営を終了します。",
  },
  {
    q: "物件が遠方でも大丈夫ですか？",
