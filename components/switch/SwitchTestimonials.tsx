...
const testimonials = [
  ...
  },
  {
    ...
    text: "副業で始めたけど、自分で運営する時間がなくて稼働率がボロボロだった。SEKAI STAYに任せてからは予約サイトの掲載が見違えた。AIで写真を加工してプロ撮影さながらの仕上がりにしてくれて、予約が一気に入り始めたのは衝撃的でした。",
  },
  {
    name: "S.A. 様",
    age: "61歳",
    ...
    text: "前の代行は月1レポートだけで、物件の状況を把握できていなかった。SEKAI STAYに切り替えてから運用の細かいところまで改善され、ゲストレビューが自然に上がりました。単価も引き上げられるようになって、妻にも「任せてよかったね」と言われました。",
  },
];
