            ...
            <div className="lg:hidden flex flex-col items-center gap-6 text-center">
              ...
              <div className="flex flex-col items-center w-full">
                <div className="relative flex justify-center items-center w-full min-h-[320px] sm:min-h-[440px]">
                  ...
                  />
                  <FloatingDataChip className="absolute top-2 left-0 sm:top-6 z-20" label="ピーク売上" value="+18%" trend="up" />
                  <FloatingDataChip className="absolute top-10 right-0 sm:top-14 z-20" label="稼働率" value="74%" trend="up" />
                  <FloatingDataChip className="absolute bottom-12 left-0 sm:bottom-20 z-20" label="清掃完了" value="3/3" trend="ok" />
                  <FloatingDataChip className="absolute bottom-4 right-0 sm:bottom-12 z-20" label="新規予約" value="2件" trend="up" />
                </div>
