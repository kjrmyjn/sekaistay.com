        ...
        <div className="fade-in">
          ...
          <div className="space-y-6 text-[14px] sm:text-[15px] lg:text-[16px] leading-[2] text-ink/75 tracking-wide">
            <p>
              ...
              手数料20%、月額固定費 ¥20,000。手元に残るのは、売上の半分以下でした。運用の中身は完全にブラックボックスで、届くレポートは月1回のPDFだけ。
            </p>
            <p>
              業界平均15〜25%という手数料率は、相場というより<strong className="text-ink">「情報の非対称性で成立してきた価格」</strong>だと気づきました。テクノロジーと運用設計を一から組み直せば、業界平均の半額ほどにできる確信がありました。
            </p>
            <p>
              ──だから私たちは、手数料 8% + 月額1万円。そしてオーナー専用のダッシュボードで、運用の中身をぜんぶ可視化しました。
            </p>
            <p>
              「お任せください」ではなく、「いつでも見られます」をプロダクトの軸に据えています。
            </p>
            <p>
              切り替えてくださったオーナー様の中には、稼働率を 58% → 82%、月売上を ¥45万 → ¥76万 に伸ばされた方もいます。手数料は半額、成果はそれ以上。これが SEKAI STAY のアプローチです。
            </p>
            <p>
              切り替えは、心理的にもオペレーション的にも、重い決断です。だからこそ、入り口は軽くしました。
            </p>
            <p>
              初期費用 ¥0（期間限定）、解約金 ¥0。
            </p>
            <p>
              最低契約期間は 6ヶ月だけお願いしています──運用の真価が数字に表れるには、それくらいの時間が必要だからです。<strong className="text-ink">「合わなければやめられる、ただし試す価値のある時間だけは確保したい」</strong>という線引きです。
            </p>
            <p>
              初回のご相談では、専門家が丁寧にお話を伺います。営業はしません。運用が変わって、結果としてお付き合いが続いたら嬉しい。それくらいのスタンスで、お会いできればと思っています。
            </p>
