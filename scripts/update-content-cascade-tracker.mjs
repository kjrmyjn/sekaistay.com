...
ただ、2025 年に改正旅館業法が施行されて、衛生・管理規制が強化された。
2026 年は、その波を受けて「整理の段階」に入る年だと思ってます。

新法が始まった頃の混乱期は終わって、運営できる人とできない人の差が、
ここ 1-2 年で一気に開く。
...
async function main() {
  ...
  console.log(`✅ Pipeline v9 updated: ${PIPELINE_ROWS.length} rows (民泊新法の事実関係を正確化)`);
